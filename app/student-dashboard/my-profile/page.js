...
const StudentProfileEditComponent = () => {
  ...
  useEffect(() => {
    ...
    const getStudentId = () => {
      try {
        // The signed session is authoritative. Never select a profile from
        // mutable browser storage, which may be stale or belong to another user.
        const id =
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto mt-24">
        ...
        <div className="mt-6">
          <GoogleCalendarSettings ownerType="student" />
        </div>
      </div>
